      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <div className="space-y-2">
            <div className="h-9 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg w-80"></div>
            <div className="h-5 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-64"></div>
          </div>
          <div className="h-12 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl w-40 shadow-lg"></div>
        </div>
      </div>
    </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-2xl shadow-xl border border-slate-200/50 p-8 hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center">
            <div className="bg-gradient-to-br from-slate-500 to-slate-600 rounded-2xl p-4 mr-6 shadow-lg">
              <div className="w-8 h-8 bg-white/20 rounded"></div>
            </div>
            <div>
              <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-32 mb-2"></div>
              <div className="h-10 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-16"></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-2xl shadow-xl border border-slate-200/50 p-8 hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center">
            <div className="bg-gradient-to-br from-slate-600 to-slate-700 rounded-2xl p-4 mr-6 shadow-lg">
              <div className="w-8 h-8 bg-white/20 rounded"></div>
            </div>
            <div>
              <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-24 mb-2"></div>
              <div className="h-10 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-12"></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-2xl shadow-xl border border-slate-200/50 p-8 hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center">
            <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-4 mr-6 shadow-lg">
              <div className="w-8 h-8 bg-white/20 rounded"></div>
            </div>
            <div>
              <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-20 mb-2"></div>
              <div className="h-10 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-20"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-linear-to-br from-white to-slate-50 rounded-2xl shadow-2xl border border-slate-200/50 overflow-hidden">
        ...
        <div className="px-8 py-6 bg-linear-to-r from-slate-100 to-slate-200 border-b border-slate-300">
          <div className="h-7 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-48 mb-2"></div>
          <div className="h-5 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-56"></div>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-6 bg-white/60 rounded-xl border border-slate-200/50 hover:bg-white/80 hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                <div className="h-6 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-56 mb-3"></div>
              ...
              <div className="text-right mr-6">
                <div className="h-8 bg-gradient-to-r from-emerald-200 to-emerald-300 rounded w-12 mb-1"></div>
            ...
            <div className="flex items-center justify-between p-6 bg-white/60 rounded-xl border border-slate-200/50 hover:bg-white/80 hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                <div className="h-6 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-48 mb-3"></div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded"></div>
              ...
              <div className="text-right mr-6">
                <div className="h-8 bg-gradient-to-r from-emerald-200 to-emerald-300 rounded w-10 mb-1"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-12"></div>
              </div>
              <div className="w-3 h-3 bg-emerald-500 rounded-full"></div>
            </div>
            ...
            <div className="flex items-center justify-between p-6 bg-white/60 rounded-xl border border-slate-200/50 hover:bg-white/80 hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                <div className="h-6 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-52 mb-3"></div>
                <div className="flex items-center space-x-2">
                  <div className="w-4 h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded"></div>
    ...
    <div className="bg-linear-to-r from-slate-50 to-white shadow-lg border-b border-slate-200">
      <div className="px-4 py-4">
        <div className="flex flex-col space-y-3">
          <div className="h-7 bg-gradient-to-r from-gray-200 to-gray-300 rounded-lg w-48"></div>
          <div className="h-10 bg-gradient-to-r from-gray-200 to-gray-300 rounded-xl w-32 shadow-lg"></div>
        </div>
      </div>
    </div>
    ...
    <div className="px-4 py-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-xl shadow-lg border border-slate-200/50 p-4">
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-slate-500 to-slate-600 rounded-xl p-3 shadow">
              <div className="w-6 h-6 bg-white/20 rounded"></div>
            </div>
            <div className="space-y-1">
              <div className="h-8 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-12"></div>
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-xl shadow-lg border border-slate-200/50 p-4">
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-slate-600 to-slate-700 rounded-xl p-3 shadow">
              <div className="w-6 h-6 bg-white/20 rounded"></div>
            </div>
            <div className="space-y-1">
              <div className="h-8 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-10"></div>
              <div className="h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-14"></div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-xl shadow-lg border border-slate-200/50 p-4">
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl p-3 shadow">
              <div className="w-6 h-6 bg-white/20 rounded"></div>
            </div>
            <div className="space-y-1">
        ...
        <div className="bg-linear-to-br from-white to-slate-50 rounded-xl shadow-lg border border-slate-200/50 p-4">
          <div className="space-y-3">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-3 shadow">
              <div className="w-6 h-6 bg-white/20 rounded"></div>
            </div>
            <div className="space-y-1">
              <div className="h-8 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-8"></div>
      ...
      <div className="bg-linear-to-br from-white to-slate-50 rounded-xl shadow-xl border border-slate-200/50 overflow-hidden">
        ...
        <div className="px-4 py-4 bg-linear-to-r from-slate-100 to-slate-200 border-b border-slate-300">
          <div className="h-6 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-40 mb-1"></div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="p-4 bg-white/60 rounded-lg border border-slate-200/50">
            <div className="space-y-3">
              <div className="h-5 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-40"></div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-24"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-12"></div>
              </div>
              <div className="flex items-center justify-between pt-2">
                <div className="h-6 bg-gradient-to-r from-emerald-200 to-emerald-300 rounded w-10"></div>
          ...
          <div className="p-4 bg-white/60 rounded-lg border border-slate-200/50">
            <div className="space-y-3">
              <div className="h-5 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-36"></div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-20"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-16"></div>
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="h-6 bg-gradient-to-r from-emerald-200 to-emerald-300 rounded w-8"></div>
                <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 bg-white/60 rounded-lg border border-slate-200/50">
            <div className="space-y-3">
              <div className="h-5 bg-gradient-to-r from-gray-300 to-gray-400 rounded w-44"></div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 bg-gradient-to-r from-gray-200 to-gray-300 rounded"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-28"></div>
                <div className="h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded w-12"></div>
